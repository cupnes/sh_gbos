...
GB_NR23_BIT_FREQ_C4=0b	# ド4
GB_NR23_BIT_FREQ_D4=42	# レ4
GB_NR23_BIT_FREQ_E4=72	# ミ4
GB_NR23_BIT_FREQ_F4=89	# ファ4
GB_NR23_BIT_FREQ_G4=b2	# ソ4
GB_NR23_BIT_FREQ_A4=d6	# ラ4
GB_NR23_BIT_FREQ_B4=f7	# シ4
GB_NR23_BIT_FREQ_C5=06	# ド5

GB_NR24_BIT_RESTART_SOUND=80
GB_NR24_BIT_COUNT_CONSEC_SEL=40
GB_NR24_BIT_FREQ_C4=06	# ド4
GB_NR24_BIT_FREQ_D4=06	# レ4
GB_NR24_BIT_FREQ_E4=06	# ミ4
GB_NR24_BIT_FREQ_F4=06	# ファ4
GB_NR24_BIT_FREQ_G4=06	# ソ4
GB_NR24_BIT_FREQ_A4=06	# ラ4
GB_NR24_BIT_FREQ_B4=06	# シ4
GB_NR24_BIT_FREQ_C5=07	# ド5
...
gb_cart_header_no_title() {
	...
	echo -en '\x00'	# ROM ONLY

	# 0x0148 - ROM Size
	echo -en '\x00'	# 32KByte (no ROM banking)
	...
	# A value of 33h signalizes that the New License Code in header bytes
	# 0144-0145 is used instead.
